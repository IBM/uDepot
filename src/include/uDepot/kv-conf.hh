...
struct KV_conf {
	...
	enum kv_type {
		...
		KV_UDEPOT_SALSA_TRT_URING         = 6,
		KV_UDEPOT_SALSA_TRT_SPDK          = 7,
		KV_UDEPOT_SALSA_TRT_SPDK_ARRAY    = 8,
		// Memcache types
		KV_UDEPOT_SALSA_O_DIRECT_MC       = 9,
		KV_UDEPOT_SALSA_TRT_SPDK_ARRAY_MC = 10,
		KV_UDEPOT_SALSA_TRT_AIO_MC        = 11,
		KV_UDEPOT_SALSA_TRT_URING_MC      = 12,
		KV_UDEPOT_LAST,
	};
